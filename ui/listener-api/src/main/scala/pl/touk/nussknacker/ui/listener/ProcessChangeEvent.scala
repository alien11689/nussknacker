...
object ProcessChangeEvent {
  ...
  final case class OnDeployActionSuccess(processId: ProcessId, version: Long, comment: Option[String], deployedAt: LocalDateTime, action: ActionType) extends ProcessChangeEvent
